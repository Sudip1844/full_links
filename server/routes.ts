  ...
  app.get("/", (req, res) => {
    res.json({
      ...
      endpoints: {
        ...
        quality_zips: "/api/quality-zips",
        tokens: "/api/tokens",
        universal_api: {
          single_links: "/api/create-short-link",
          quality_links: "/api/create-quality-short-link",
          episodes: "/api/create-quality-episode",
          zips: "/api/create-quality-zip"
        }
      }
    });
  });
